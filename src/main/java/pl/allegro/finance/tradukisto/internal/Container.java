...
import pl.allegro.finance.tradukisto.internal.languages.danish.DanishLongToWordsConverter;
...
public final class Container {
    ...
    public static Container danishContainer() {
        ...
        DanishThousandToWordsConverter thousandToWordsConverter =
            new DanishThousandToWordsConverter(values.baseNumbers());
        ...
        LongToStringConverter longToWordsConverter = new DanishLongToWordsConverter(
            thousandToWordsConverter,
            values.pluralForms()
        );
